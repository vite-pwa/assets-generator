...
export async function generateMaskableAsset<OutputType extends GenerateOptionsType>(
  type: OutputType,
...
if (import.meta.vitest) {
  ...
  it('should generate a maskable asset', async () => {
    const result = await generateMaskableAsset(
      'png',
